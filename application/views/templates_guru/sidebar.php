<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item ">
        <a class="nav-link" href="<?= base_url('guru/edit_data');?>">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span>Edit Profile</span></a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="<?= base_url('guru/edit_akun');?>">
          <i class="fas fa-fw fa-tachometer-alt"></i>
      ...
      <li class="nav-item ">
        <a class="nav-link" href="<?= base_url('guru/jadwal_mengajar');?>">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span>Jadwal Mengajar</span></a>
      </li>

      <li class="nav-item ">
        <a class="nav-link" href="<?= base_url('guru/absen');?>">
          <i class="fas fa-fw fa-tachometer-alt"></i>
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('guru/auth/logout')?>">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $username;?></span>
                <img class="img-profile rounded-circle" src="<?= base_url('assets/img/guru/'). $user['image'];?>" style="width:50px" >
              </a>
