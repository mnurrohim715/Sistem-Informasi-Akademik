<div class="container-fluid">
  ...
  <p>Selamat Datang <strong><?= $data_siswa['name'];?></strong> di Sistem Informasi Akademik SMA Negeri 20 Kabupaten Tangerang.</p>
  <hr>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-md-4 text-info text-center">
            <a href="<?php echo base_url()?>"><p class="nav-link small text-info">JADWAL MENGAJAR</p></a>
        ...
        <div class="row">
          ...
          <div class="col-md-4 text-info text-center">
            <a href="<?php echo base_url()?>"><p class="nav-link small text-info">JADWAL PELAJARAN</p></a>
            <i class="fas fa-3x fa-user-graduate"></i>
          </div>

          <div class="col-md-4 text-info text-center">
            <a href="<?php echo base_url()?>"><p class="nav-link small text-info">DAFTAR HADIR</p></a>
            <i class="fas fa-3x fa-user-graduate"></i>
          </div>
