...
<table class="table table-bordered table=striped table-hover">
  ...
  foreach ($b_mtk as $mtk) : ?>
  

    <tr>
      <td width="20px"><?php echo $no++ ?></td>
      <td><?php echo $mtk->name ?></td>
      <td><?php echo $mtk->kelas ?></td>
      <td><?php echo $mtk->n1 ?></td>
      <td><?php echo $mtk->n2 ?></td>
      <td><?php echo $mtk->n3 ?></td>
      <td><?php echo $mtk->uts ?></td>
      <td><?php echo $mtk->uas ?></td>
      <td width="20px"><?php echo anchor('guru/input_nilai/edit_mtk10/'.$mtk->id,'<div class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></div></td>')?>
    </tr>
