...
<table class="table table-bordered table=striped table-hover">
  ...
  foreach ($b_indo as $indo) : ?>
  

    <tr>
      <td width="20px"><?php echo $no++ ?></td>
      <td><?php echo $indo->name ?></td>
      <td><?php echo $indo->kelas ?></td>
      <td><?php echo $indo->n1 ?></td>
      <td><?php echo $indo->n2 ?></td>
      <td><?php echo $indo->n3 ?></td>
      <td><?php echo $indo->uts ?></td>
      <td><?php echo $indo->uas ?></td>
      <td width="20px"><?php echo anchor('guru/input_nilai/edit_indo11/'.$indo->id,'<div class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></div></td>')?>
    </tr>
