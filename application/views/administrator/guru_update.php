...
<div class="alert alert-success" role="alert">
    ...
    <?php foreach($data_guru as $ds) : ?>
    <form method="post" action="<?php echo base_url('administrator/guru/update_aksi')?>">

        <div class="form-group">
            <lable>Nama</lable>
            <input type="hidden" name="id_guru" value="<?php echo $ds->id_guru ?>">
        ...
        <div class="form-group">
            <lable>NIP</lable>
            <input type ="text" name="nip" class="form-control" value="<?php echo $ds->nip ?>">
            <?php echo form_error('nisn','<div class="text-danger small" ml-3>')?>
        </div>

        <div class="form-group">
            <lable>Mengajar</lable>
            <input type ="text" name="mengajar" class="form-control" value="<?php echo $ds->mengajar ?>">
            <?php echo form_error('mengajar','<div class="text-danger small" ml-3>')?>
        </div>
        ...
        <div class="form-group">
            <lable>Wali Kelas/lable>
            <input type ="text" name="wali_kelas" class="form-control" value="<?php echo $ds->wali_kelas ?>">
        ...
        <?php foreach($detail as $dt) : ?>
            ...
            <img src="<?php echo base_url().'assets/img/guru/'.$ds->image ?>" style="width:150px">
