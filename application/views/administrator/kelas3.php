...
<div class="alert alert-success" role="alert">
    <i class="fas fa-university"></i> KELAS 12
</div>
...
<table class="table table-bordered table=striped table-hover">
  ...
  foreach ($data_siswa1 as $ds) : ?>
    ...
    <tr>
      ...
      <td width="20px"><?php echo anchor('administrator/kelas/edit_kelas3/'.$ds->id_siswa,'<div class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></div></td>')?>
    </tr>
    <?php endforeach; ?>
